...
def validate_and_filter_seeds(models, dic_seeds):
    ...
    for dimension in dic_seeds:
        ...
        # for each set only one model needs to be checked, as they are all trained on the exact same vocabulary
...
def main():
    """
    Main function to 
        - load models and seeds, 
        - validate and filter the seeds, 
        - and save the final valid seeds to a JSON file.
    """

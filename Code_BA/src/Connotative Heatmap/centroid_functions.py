...
def connotative_dim(seed_vectors_1, seed_vectors_2):
    """
    Computes the centroid of the seed vectors for each category and returns the difference between the centroids.
...
def distance_centroid(dim, target_vector):
    """
    Computes the cosine similarity of a target vector to a dimension.
